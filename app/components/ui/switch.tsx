...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-4 w-4 rounded-full shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-3 data-[state=checked]:bg-zinc-900 data-[state=unchecked]:translate-x-0 data-[state=unchecked]:bg-zinc-400"
      )}
    />
  </SwitchPrimitives.Root>
));
